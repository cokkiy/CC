...
QT_BEGIN_NAMESPACE
//需要翻译的插件属性,andrew,20150908
static const char * propertyNames[] = {
QT_TRANSLATE_NOOP("PropertyName", "data"),
QT_TRANSLATE_NOOP("PropertyName", "showType"),
QT_TRANSLATE_NOOP("PropertyName", "text"),
QT_TRANSLATE_NOOP("PropertyName", "font"),
QT_TRANSLATE_NOOP("PropertyName", "alignment"),
QT_TRANSLATE_NOOP("PropertyName", "textColor"),
QT_TRANSLATE_NOOP("PropertyName", "backgroundColor"),
QT_TRANSLATE_NOOP("PropertyName", "backgroundImage"),
QT_TRANSLATE_NOOP("PropertyName", "lineColor"),
QT_TRANSLATE_NOOP("PropertyName", "lineStyle"),
QT_TRANSLATE_NOOP("PropertyName", "lineWidth"),
QT_TRANSLATE_NOOP("PropertyName", "lineLength"),
QT_TRANSLATE_NOOP("PropertyName", "borderColor"),
QT_TRANSLATE_NOOP("PropertyName", "borderWidth"),
QT_TRANSLATE_NOOP("PropertyName", "borderStyle"),
QT_TRANSLATE_NOOP("PropertyName", "radius"),
QT_TRANSLATE_NOOP("PropertyName", "rotate"),
QT_TRANSLATE_NOOP("PropertyName", "geometry"),
};
...
/*!
    Returns the property's translate name.

    \sa propertyName()
*/
QString QtProperty::trPropertyName() const
{
    QString name = d_ptr->m_name;
    const int propertyNameCount = sizeof(propertyNames)/sizeof(const char *);
    for(int pos = 0;pos<propertyNameCount;pos++)
    {
        if(name.compare(propertyNames[pos])==0)
        {
            return QCoreApplication::translate("PropertyName", propertyNames[pos]);
        }
    }
    return name;
}
