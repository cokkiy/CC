...
void FormWindow::downWidgets()
{
    ...
    beginCommand(tr("Down widgets"));
    foreach (QWidget *widget, widgets) {
        DownWidgetCommand *cmd = new DownWidgetCommand(this);
        cmd->init(widget);
        m_undoStack.push(cmd);
    }
    endCommand();
...
void FormWindow::upWidgets()
{
    ...
    beginCommand(tr("Down widgets"));
    foreach (QWidget *widget, widgets) {
        UpWidgetCommand *cmd = new UpWidgetCommand(this);
        cmd->init(widget);
        m_undoStack.push(cmd);
    }
    endCommand();
...
QMenu *FormWindow::createPopupMenu(QWidget *w)
{
    ...
    if (!isFormWindow) {
        ...
        if (manager->action(QDesignerFormWindowManagerInterface::LowerAction)->isEnabled()) {
            ...
            popup->addAction(manager->action(QDesignerFormWindowManagerInterface::DownAction));
            popup->addAction(manager->action(QDesignerFormWindowManagerInterface::UpAction));
    ...
    layoutMenu->addAction(manager->action(QDesignerFormWindowManagerInterface::DefaultPreviewAction));
