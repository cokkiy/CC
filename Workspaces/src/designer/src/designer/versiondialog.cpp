            ...
            )
{
    ...
    QString version = tr("<h3>%1</h3><br/><br/>版本 %2");
    version = version.arg(tr("二十基地试验任务指挥显示系统应用软件")).arg(tr("0.0.1"));
    version.append(tr("<br/>指显软件用于帮助专家和首长及时掌握试验任务状态，并提供辅助决策功能!<br/>"));

    lbl->setText(tr("%1"
                    "<br/>Copyright (C) 2014 二十基地试验技术部四室"
                    ).arg(version));
