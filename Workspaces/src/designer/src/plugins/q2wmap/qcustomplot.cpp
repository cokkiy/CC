...
QCustomPlot::QCustomPlot(QWidget *parent) :
  ...
  mBackgroundBrush(Qt::transparent, Qt::SolidPattern),//rika修改 Qt::white ==》Qt::transparent
...
void QCustomPlot::mousePressEvent(QMouseEvent *event)
{
  ...
  //添加父窗口的鼠标按下事件 rika add 20150907
  ((Q2wmap*)m_parent)->mousePressEvent(event);
}
...
void QCustomPlot::mouseMoveEvent(QMouseEvent *event)
{
  ...
  //添加父窗口的鼠标移动事件 rika add 20150907
  ((Q2wmap*)m_parent)->mouseMoveEvent(event);
}

//右键菜单事件 rika add 20150907
void QCustomPlot::contextMenuEvent(QContextMenuEvent *event)
{
    //添加右键菜单事件
    ((Q2wmap*)m_parent)->contextMenuEvent(event);
}
...
void QCustomPlot::mouseReleaseEvent(QMouseEvent *event)
{
  ...
  //添加父窗口的鼠标松开事件 rika add 20150907
  ((Q2wmap*)m_parent)->mouseReleaseEvent(event);
}
  ...
  mDragging(false)
{
  ...
  //setMinimumMargins(QMargins(15, 15, 15, 15));  重新设置边距值 by Rika 20150819
...
/*!
  ...
  设置独立数据点的视觉外观，如设置了QCPScatterStyle::ssNone，则不绘制零散的点
*/
