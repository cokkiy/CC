...
public:
    ...
    QPointer<QDesignerImageExplorerInterface> m_imageexplorer;
...
/*!
    Returns an interface to \QD's image explorer.
*/
QDesignerImageExplorerInterface *QDesignerFormEditorInterface::imageExplorer() const
{
    return d->m_imageexplorer;
}
/*!
    Sets \QD's image explorer to be the specified \a
    ImageExplorer.

    \sa imageExplorer()
*/
void QDesignerFormEditorInterface::setImageExplorer(QDesignerImageExplorerInterface *imageexplorer)
{
    d->m_imageexplorer = imageexplorer;
}
/*!
    \internal
