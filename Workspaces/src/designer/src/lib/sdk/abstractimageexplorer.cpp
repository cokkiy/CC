#include "abstractimageexplorer.h"
...
*/
QDesignerImageExplorerInterface::QDesignerImageExplorerInterface(QWidget *parent, Qt::WindowFlags flags)
...
*/
QDesignerImageExplorerInterface::~QDesignerImageExplorerInterface()
{
}
...
/*!
    ...
    object.
*/
QDesignerFormEditorInterface *QDesignerImageExplorerInterface::core() const
{
    return 0;
}

/*!
    \fn void QDesignerImageExplorerInterface::setFormWindow(QDesignerFormWindowInterface *formWindow)
