...
class QDESIGNER_SHARED_EXPORT DownWidgetCommand: public ChangeZOrderCommand
{

public:
    explicit DownWidgetCommand(QDesignerFormWindowInterface *formWindow);
...
protected:
    ...
    virtual void reorder(QWidget *widget) const;
private:
    QPointer<QWidget> m_oldAfter;
};

class QDESIGNER_SHARED_EXPORT UpWidgetCommand: public ChangeZOrderCommand
{

public:
    explicit UpWidgetCommand(QDesignerFormWindowInterface *formWindow);
