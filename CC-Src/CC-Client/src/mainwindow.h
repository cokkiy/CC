...
private slots:
  ...
  //自动设置网络参数
  void on_actionAutoNetSetting_triggered();
  //自动更新工作站列表
  ...
  // block station
  void on_actionNetBlock_triggered();

  // net traffic viewer
  void on_actionNetTrafficViewer_triggered();
  // upgrading system
  void on_actionSystemUpgrade_triggered();
  // create virtual network interface
  void on_actionCreateVirtualNI_triggered();
