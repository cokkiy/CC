...
public:
  ...
  */
  StationInfo *
  find(const std::pair<const std::string, std::list<std::string>> &);
  ...
  */
  std::list<StationInfo>::iterator begin() { return allStations.begin(); }
  ...
  */
  std::list<StationInfo>::iterator end() { return allStations.end(); }
  ...
  */
  void subscribeAllStationsPropertyChangedEvent(const QObject *receiver,
                                                const char *member);
  ...
  */
  void subscribeAllStationsStateChangedEvent(const QObject *receiver,
                                             const char *member);
  ...
  创建时间：2015/11/13 10:57:28
  */
  void subscribeAllStationsChangedEvent(const QObject *receiver,
                                        const char *member);
  ...
  */
  void remove(const StationInfo *s);
