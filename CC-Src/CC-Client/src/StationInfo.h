...
public:
  ...
  public:
    ...
    */
    ...
    /*
      block this device or not
    */
    void block(bool isBlock) { blocked = isBlock; }
...
public:
  ...
  //设置操作状态和消息
  void setState(OperatingStatus status,
...
public:
  ...
  */
  void addStartApp(const QString &path, const QString &arguments,
                   const QString &procName, bool allowMultiInstance);
  ...
  */
  // bool operator==(const StationInfo &ref) { return this == &ref; }
  ...
  */
  void addToSendedFileList(const QString &fileName,
