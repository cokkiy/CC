...
#include "../CC-Client/sendfiledialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SendFileDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 45, 25)
    ...
    "SendFileDialog\0on_browserPushButton_clicked\0"
    "\0on_sendPushButton_clicked"
};
...
void SendFileDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_browserPushButton_clicked(); break;
...
const QMetaObject SendFileDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SendFileDialog.data,
      qt_meta_data_SendFileDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SendFileDialog.stringdata))
